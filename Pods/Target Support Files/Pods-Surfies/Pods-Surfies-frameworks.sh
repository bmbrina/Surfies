...
if [[ "$CONFIGURATION" == "Debug-Staging" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/APAvatarImageView/APAvatarImageView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/JDFTooltips/JDFTooltips.framework"
